        ...
        <div className="max-w-3xl mx-auto space-y-12">
          <div className="relative pl-8">
            ...
            <div className="bg-dark-light p-6 rounded-lg border border-primary/10">
              <div className="flex justify-between items-center mb-4">
                ...
                <span className="text-primary-light text-sm">2016 - 2018</span>
              </div>
              <p className="text-primary mb-2">Stanford University</p>
              <p className="text-white/80">Specialized in Advanced Web Technologies and Artificial Intelligence</p>
            </div>
          </div>
          ...
          <div className="relative pl-8">
            ...
            <div className="bg-dark-light p-6 rounded-lg border border-primary/10">
              ...
              <p className="text-white/80">Focus on Software Development and Database Management</p>
            </div>
          </div>
          ...
          <div className="relative pl-8">
            ...
            <div className="bg-dark-light p-6 rounded-lg border border-primary/10">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-bold text-white">Advanced Web Development Certification</h3>
                <span className="text-primary-light text-sm">2015</span>
              </div>
              <p className="text-primary mb-2">Udacity</p>
              <p className="text-white/80">Specialized training in modern frontend frameworks and responsive design</p>
            </div>
          </div>
        </div>
      </div>
